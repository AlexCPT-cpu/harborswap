...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="flex flex-row space-x-4 border border-black dark:border-neutral-600 p-2 rounded-xl w-80 lg:w-[510px] hover:border-yellow-300/70 dark:hover:border-yellow-300/70 cursor-pointer"
    >
